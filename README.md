...
🛠️ Tech Stack
CategoryTechnologyLanguageKotlinUI FrameworkJetpack ComposeArchitectureMVVM + Repository PatternLocal DatabaseRoom DB with KSPAsyncKotlin Coroutines + FlowState ManagementStateFlow + collectAsState()NavigationJetpack Navigation ComposePreferencesSharedPreferencesNotificationsNotificationCompatSplash ScreenCore SplashScreen APIBuild ToolGradle with KSP
...
bashgit clone https://github.com/yourusername/CampusSync.git
